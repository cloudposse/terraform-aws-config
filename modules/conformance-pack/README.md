...
| Name | Type |
|------|------|
| [aws_config_conformance_pack.default](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/config_conformance_pack) | resource |
...
|------|-------------|------|---------|:--------:|
| <a name="input_access_token"></a> [access\_token](#input\_access\_token) | Optional: access token required to access private GitHub repos, where custom conformance packs could be stored | `string` | `""` | no |
...
| <a name="input_conformance_pack"></a> [conformance\_pack](#input\_conformance\_pack) | The URL to a Conformance Pack | `string` | n/a | yes |
...
| <a name="input_parameter_overrides"></a> [parameter\_overrides](#input\_parameter\_overrides) | A map of parameters names to values to override from the template | `map(any)` | `{}` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_arn"></a> [arn](#output\_arn) | ARN of the conformance pack |
