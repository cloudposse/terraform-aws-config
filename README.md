...
| <a name="input_enable_exclusion"></a> [enable_exclusion](#input\_enable_exclusion) | Determines if use EXCLUSION_BY_RESOURCE_TYPES strategy followed with `resource_types` list | `bool` | `false` | no |
| <a name="input_enable_inclusion"></a> [enable_inclusion](#input\_enable_exclusion) | Determines if use INCLUSION_BY_RESOURCE_TYPES strategy followed with `resource_types` list | `bool` | `false` | no |
| <a name="input_resource_types"></a> [resource\_types](#input\_resource_types) | A list of service types to include or exclude depending of enable inclusion or exclusion | `list(string)` | `[]` | no |
